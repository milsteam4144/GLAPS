...
#filepath="/home/mallory/Desktop/2017/best_model.h5"
#earlyStopping = keras.callbacks.EarlyStopping(monitor='val_loss', patience=10, verbose=0, mode='min')
#mcp_save = keras.callbacks.ModelCheckpoint(filepath, save_best_only=False, monitor='val_loss', mode='min', save_weights_only=False)
...
print(test_data[0].reshape(1,-1).shape)
